...
class Tkpipe(Frame):
    ...
    def createWidgets(self):
        ...
        self.txt_messages["background"] = "black"
        self.txt_messages["foreground"] = "white"
        self.txt_messages.tag_config("green", foreground="green")
        self.txt_messages.tag_config("blue", foreground="blue")
        self.txt_messages.tag_config("red", foreground="red")
